 ...
 *
 * <p>Numbers are wall-clock and noisy — use them for relative comparison
 * between branches, not absolute reporting.
 */
...
class ColorPerfBenchmark {
    ...
    void run() throws Exception {
        ...
        List<String> cases = List.of(
                "01_basic_shapes.svg",
                "02_gradients.svg",
                "03_complex_paths.svg",
                "05_transforms.svg",
                "06_stroke_styles.svg",
                "07_opacity_blend.svg",
                "09_css_styling.svg",
                "13_patterns.svg",
                "17_filters.svg",
                "20_fe_blend_modes.svg");

        System.out.printf(Locale.US,
                "%n%-28s %10s %10s %10s%n", "case", "avg ms", "p50 ms", "min ms");
        ...
        for (String name : cases) {
            ...
            System.out.printf(Locale.US,
                    "%-28s %10.2f %10.2f %10.2f%n", name, avg, median, min);
        }
